...
export default {
  ...
  [RECEIVE_LAT_LNG_CITY](state, { currentCity }) {
    let initData = { id: currentCity.id, nm: currentCity.city, py: currentCity.cityPinyin }
    console.log(currentCity);
    window.localStorage.setItem('city', JSON.stringify(initData))
  },
  ...
  // 获取更多搜索电影
  [RECEIVE_SEARCH_MOVIE](state, { moreSearchMovie }) {
    state.moreSearchMovie = [...state.moreSearchMovie, ...moreSearchMovie]
  },
}